        ...
        <DialogContent className="max-w-2xl font-instrument_sans">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <p className="text-xs text-gray-500">控制写作风格（例如：轻松、专业、幽默）。</p>
              <Select
            ...
            <div className="w-full flex flex-col gap-2">
              ...
              <p className="text-xs text-gray-500">控制幻灯片描述的详细程度：简洁、标准或详细。</p>
              <Select
            ...
            <div className="w-full flex flex-col gap-2 p-3 rounded-md bg-blue-100 border-blue-200">
              ...
              <p className="text-xs text-gray-600">添加摘要幻灯片概述各部分内容（需要3张以上幻灯片）。</p>
            </div>
            <div className="w-full flex flex-col gap-2 p-3 rounded-md bg-blue-100 border-blue-200">
              <div className="flex items-center justify-between">
            ...
            <div className="w-full sm:col-span-2 flex flex-col gap-2">
              <label className="text-sm font-semibold text-gray-700">说明</label>
              <p className="text-xs text-gray-500">可选的AI指导说明。这些说明会覆盖默认设置，但格式约束除外。</p>
              <Textarea
                value={advancedDraft.instructions}
                rows={4}
                onChange={(e) => setAdvancedDraft((prev) => ({ ...prev, instructions: e.target.value }))}
                placeholder="示例：专注于企业客户，强调投资回报率和安全合规性。保持幻灯片数据驱动，避免专业术语，并在最后一张幻灯片上包含简短的行动号召。"
